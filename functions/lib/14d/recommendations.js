...
exports.generateRecommendations = functions
    ...
    try {
        ...
        if (gapAnalysis.topPriorities) {
            gapAnalysis.topPriorities.forEach((gap, index) => {
 ...
 */
function generateDimensionRecommendations(gap, index) {
 ...
 */
function generatePrimaryRecommendation(dimensionId, dimensionName, priority, gap) {
    const recommendationsByDimension = {
        1: {
            ...
            actionDescription: 'Set up comprehensive learning analytics system to track student progress real-time. Provide teachers with data dashboards to identify learning gaps early.',
        ...
        2: {
            ...
            actionDescription: 'Conduct comprehensive curriculum audit. Align pedagogy with active learning principles. Introduce project-based learning and collaborative activities.',
        ...
        3: {
            ...
            actionDescription: 'Establish structured professional development. Conduct coaching sessions and mentoring for new teachers. Create peer learning communities.',
        ...
        4: {
            ...
            actionDescription: 'Launch comprehensive wellbeing program. Increase counselor availability and train teachers in mental health awareness.',
    ...
    return (recommendationsByDimension[dimensionId] || {
 ...
 */
function generateSecondaryRecommendation(dimensionId, dimensionName, priority, gap) {
    return {
 ...
 */
function calculateBudgetEstimate(recommendations) {
    let lowEstimate = 0;
    let highEstimate = 0;
 ...
 */
async function createActionPlan(schoolId, assessmentId, result) {
    const actionPlan = {
        phase1: {
