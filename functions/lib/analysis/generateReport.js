...
exports.generateDiagnosticReport = void 0;
    ...
    try {
        ...
        for (let d = 1; d <= 14; d++) {
            ...
            dimensionAnalysis[dimensionId] = {
                ...
                recommendations: getRecommendationsForDimension(dimensionId, cycleData?.scores?.healthIndex || 0)
            };
        }
        // Generate overall recommendations
        const recommendations = generateRecommendations(cycleData?.scores, dimensionAnalysis, cycleData?.respondentsByRole);
        // Compile report
        const report = {
            schoolId,
            cycleId,
 ...
 */
function getRecommendationsForDimension(dimensionId, healthIndex) {
 ...
 * Generate overall recommendations
 */
function generateRecommendations(scores, dimensionAnalysis, respondentsByRole) {
    const recommendations = [];
    if (!scores)
        return recommendations;
...
exports.default = { generateDiagnosticReport: exports.generateDiagnosticReport };
