...
export const Staff = () => {
  const { staff, addStaff, activeSchool } = useAppStore();
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            {activeSchool && (
              <span className="bg-indigo-100 text-indigo-900 text-xs font-extrabold px-2.5 py-1 rounded-lg border border-indigo-200">
                {activeSchool.name}
              </span>
            )}
          </div>
          <p className="text-gray-500 mt-1 font-medium">Manage faculty directories, department mappings, performance indices, and retention stats.</p>
        </div>
        <button 
