...
import { ArrowRight, PlusCircle, CheckCircle2, Lock, Users, Clock, RefreshCw, AlertCircle, Database, Layers, Settings, Zap, BarChart3, BookOpen, Lightbulb } from 'lucide-react';
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      ...
                      <p className="text-blue-800">
                        {progress.totalActual} of {config.totalExpected} respondents ({config.totalExpected === 0 ? 0 : Math.round((progress.totalActual / config.totalExpected) * 100)}%)
                      </p>
                    </div>
